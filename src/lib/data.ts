import type { Personnel, Resident, BoardMember, Villa, Transaction, Document, PayrollRecord, CompanyInfo } from './types';
...
export const initialVillas: Villa[] = [
  ...
  { id: 2, name: "ویلا ۲", owner: "شهمیری (احمدی)", area: 200, residentInfo: "شهمیری (احمدی)", phone: "09394957877" },
